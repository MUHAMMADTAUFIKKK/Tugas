...
10. Apabila kita melihatnya di perangkat, maka akan terlihat seperti ini:
	![hasil](assets/btc-59.png)*Keterangan:*
...
```
![hasil](assets/bf-r1.png)
8. Hasilnya akan seperti ini:
	  ![hasil](assets/bf-5.png) 
